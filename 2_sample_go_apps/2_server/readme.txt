Простое приложение веб-сервер, отдающее статику.
Также в директории есть манифест deployment-server.yaml для создания deployment'а с нашим приложением.
...
Например: 
$ docker tag go-server-app-image:latest localhost:32000/go-server-app-image:latest

3) Затем выполнить push:
$ docker push localhost:32000/<imageName:version>.

Например:
$ docker push localhost:32000/go-server-app-image:latest
